...
const options = {
	...
	icon: './app/icon',
	ignore: new RegExp(`${__dirname}\\${sep}(\\.rpt2_cache|\\.vs|\\.vscode|css|src|wiki|\\.git\\w*|build\\w*\\.|bundle\\w*\\.|clicommands\\.txt|jsconfig\\.json|package\\-lock\\.json|tslint\\.json|tsconfig\\.json)`),
	name: 'tdeheroes',
	out: './dist',
	overwrite: true,
	prune: true,
