...
export const {
  actions: {
    addInstance: addArcaneOrbEnchantment,
    changeInstanceLevel: changeArcaneOrbEnchantmentLevel,
    removeInstance: removeArcaneOrbEnchantment,
  },
  reducer: arcaneOrbEnchantmentsReducer,
} = createActivatableSlice({
  entityName: "ArcaneOrbEnchantment",
  getState: state => state.specialAbilities.arcaneOrbEnchantments,
  getPrerequisites: (id, database) => database.arcaneOrbEnchantments[id]?.prerequisites ?? [],
  getAdventurePointsValue: staticEntry => staticEntry.ap_value,
  createIdentifierObject: getCreateIdentifierObject("ArcaneOrbEnchantment"),
