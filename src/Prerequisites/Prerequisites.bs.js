...
import * as Prerequisite$OptolithClient from "./Prerequisite.bs.js";
  ...
  switch (staticEntry.TAG | 0) {
    ...
    case /* SpecialAbility */2 :
        ...
        if (typeof match$2 === "number") {
            ...
            if (match$2 >= 26) {
              ...
              switch (match$2) {
                case /* SkillSpecialization */0 :
                    ...
                    tmp = Ley_List$OptolithClient.append(Curry._1(Ley_Option$OptolithClient.optionToList, sameSkillDependency), Curry._1(Ley_Option$OptolithClient.optionToList, Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, sid, (function (param) {
          ...
          if (exit === 1) {
            tmp = Ley_Option$OptolithClient.fromOption(/* [] */0, Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, sid, (function (param) {
                            return Activatable_SelectOptions$OptolithClient.getSelectOption(staticEntry, param);
                          })), (function (option) {
