...
export const Monad: {
  liftM3: <T1,T2,T3,T4,T5>(f:((_1:T1, _2:T2, _3:T3) => T4), mx:
    {
    tag: "Ok"; 
    value: T1
  }
  ...
  liftM2: <T1,T2,T3,T4>(f:((_1:T1, _2:T2) => T3), mx:
    {
    tag: "Ok"; 
    value: T1
  }
  ...
  liftM4: <T1,T2,T3,T4,T5,T6>(f:((_1:T1, _2:T2, _3:T3, _4:T4) => T5), mx:
    {
    tag: "Ok"; 
    value: T1
  }
...
export const Functor: { fmap: <T1,T2,T3>(_1:((_1:T1) => T2), _2:
    { tag: "Ok"; value: T1 }
  | { tag: "Error"; value: T3 }) => 
    { tag: "Ok"; value: T2 }
  | { tag: "Error"; value: T3 } } = Ley_ResultBS.Functor

export const Extra: {
  fromError: <T1,T2>(def:T1, x:
    {
    tag: "Ok"; 
    value: T2
  }
  ...
  optionToResult: <T1,T2>(error:T1, x:(null | undefined | T2)) => 
    {
    tag: "Ok"; 
    value: T2
  }
  ...
  optionToResult_: <T1,T2>(_1:(() => T1), _2:(null | undefined | T2)) => 
    {
    tag: "Ok"; 
    value: T2
  }
...
export const Foldable: {
  foldl: <T1,T2,T3>(f:((_1:T1, _2:T2) => T1), init:T1, mx:
    {
    tag: "Ok"; 
    value: T2
  }
  ...
  concatMap: <T1,T2,T3>(f:((_1:T1) => list<T2>), mx:
    {
    tag: "Ok"; 
    value: T1
  }
  ...
  any: <T1,T2>(pred:((_1:T1) => boolean), mx:
    {
    tag: "Ok"; 
    value: T1
  }
  ...
  find: <T1,T2>(pred:((_1:T1) => boolean), mx:
    {
    tag: "Ok"; 
    value: T1
  }
  ...
  foldr: <T1,T2,T3>(f:((_1:T1, _2:T2) => T2), init:T2, mx:
    {
    tag: "Ok"; 
    value: T1
  }
  ...
  all: <T1,T2>(pred:((_1:T1) => boolean), mx:
    {
    tag: "Ok"; 
    value: T1
  }
...
} = Ley_ResultBS.Foldable

export const Bifunctor: {
  first: <T1,T2,T3>(f:((_1:T1) => T2), x:
    {
    tag: "Ok"; 
    value: T3
  }
  ...
  second: <T1,T2,T3>(_1:((_1:T1) => T2), _2:
    {
    tag: "Ok"; 
    value: T1
  }
  ...
  bimap: <T1,T2,T3,T4>(fError:((_1:T1) => T2), fOk:((_1:T3) => T4), x:
    {
    tag: "Ok"; 
    value: T3
  }
...
} = Ley_ResultBS.Bifunctor

export const Applicative: { ap: <T1,T2,T3>(_1:
    { tag: "Ok"; value: ((_1:T1) => T2) }
  | { tag: "Error"; value: T3 }, _2:
    { tag: "Ok"; value: T1 }
  | { tag: "Error"; value: T3 }) => 
    { tag: "Ok"; value: T2 }
  | { tag: "Error"; value: T3 } } = Ley_ResultBS.Applicative
