	...
	return (
		<div className="tradition-properties">
			<div className="primary">
				<span className="label">{translate(locale, 'charactersheet.spells.traditionsproperties.labels.primaryattribute')}</span>
				<span className="value">{magicalPrimary}</span>
			</div>
			<div className="properties">
				<span className="label">{translate(locale, 'charactersheet.spells.traditionsproperties.labels.properties')}</span>
				<span className="value">{properties.join(', ')}</span>
			</div>
			<div className="tradition">
				<span className="label">{translate(locale, 'charactersheet.spells.traditionsproperties.labels.tradition')}</span>
