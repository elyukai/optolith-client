...
import { SecondaryAttribute, UIMessages } from '../../types/data';
...
export function CombatSheetLifePoints(props: CombatSheetLifePointsProps) {
  ...
  return (
    <TextBox label={translate(locale, 'charactersheet.combat.lifepoints.title')} className="life-points">
      <div className="life-points-first">
        <LabelBox label={translate(locale, 'charactersheet.combat.lifepoints.labels.max')} value={lp} />
        <LabelBox label={translate(locale, 'charactersheet.combat.lifepoints.labels.current')} value="" />
      </div>
