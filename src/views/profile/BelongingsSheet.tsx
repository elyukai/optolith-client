...
import { Attribute, Item, UIMessages } from '../../types/view';
  ...
  return (
    <SheetWrapper>
      ...
      <Sheet
        ...
        >
        <div className="upper">
          <TextBox label={translate(locale, 'charactersheet.belongings.equipment.title')} className="equipment">
            <div>
              <table>
                <thead>
                  <tr>
                    <th className="name">{translate(locale, 'charactersheet.belongings.equipment.headers.item')}</th>
                    <th className="amount">{translate(locale, 'charactersheet.belongings.equipment.headers.number')}</th>
                    <th className="price">{translate(locale, 'charactersheet.belongings.equipment.headers.price')}</th>
                    <th className="weight">{translate(locale, 'charactersheet.belongings.equipment.headers.weight')}</th>
                    <th className="where">{translate(locale, 'charactersheet.belongings.equipment.headers.carriedwhere')}</th>
                  </tr>
                </thead>
                <tbody>
                  {
            ...
            <div className="total">
              <label>{translate(locale, 'charactersheet.belongings.equipment.footers.total')}</label>
              <span>{localizeNumber(Math.round(totalPrice * 100) / 100, locale.id)}</span>
              <span>{localizeNumber(localizeWeight(Math.round(totalWeight * 100) / 100, locale.id), locale.id)}</span>
            </div>
          </TextBox>
          <TextBox label={translate(locale, 'charactersheet.belongings.purse.title')} className="purse">
            <div className="top">
              <LabelBox
                className="money"
            ...
            <div className="carrying-capacity">
              ...
              <LabelBox
                ...
                value={localizeWeight(value * 2, locale.id)}
                />
            </div>
          </TextBox>
        </div>
