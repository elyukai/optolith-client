...
export type Category = ADVANTAGES | ATTRIBUTES | BLESSINGS | CANTRIPS | COMBAT_TECHNIQUES | CULTURES | DISADVANTAGES | LITURGIES | PROFESSION_VARIANTS | PROFESSIONS | RACES | SPECIAL_ABILITIES | SPELLS | TALENTS;
