...
function spellEnhancements(spells, xs) {
  return Curry._1(Ley_IntMap$OptolithClient.fromList, Ley_List$OptolithClient.Monad.$great$great$eq(xs, (function (enhancement) {
                    return Ley_Option$OptolithClient.option(/* [] */0, (function (spell) {
                                  var match = enhancement.level3.requirePrevious;
                                  return {
                                          hd: getSingle(spell, 1, enhancement.level1.id, enhancement.level1.name, enhancement.level1.cost, enhancement.level1.effect, Prerequisite$OptolithClient.empty, enhancement.src, enhancement.errata),
                                          tl: {
                                            hd: getSingle(spell, 2, enhancement.level2.id, enhancement.level2.name, enhancement.level2.cost, enhancement.level2.effect, {
                                            ...
                                            tl: {
                                              hd: getSingle(spell, 3, enhancement.level3.id, enhancement.level3.name, enhancement.level3.cost, enhancement.level3.effect, {
                                                    sex: Prerequisite$OptolithClient.empty.sex,
                                                    race: Prerequisite$OptolithClient.empty.race,
                                                    culture: Prerequisite$OptolithClient.empty.culture,
                                                    pact: Prerequisite$OptolithClient.empty.pact,
                                ...
                                }), Curry._2(Ley_IntMap$OptolithClient.lookup, enhancement.target, spells));
                  })));
}
