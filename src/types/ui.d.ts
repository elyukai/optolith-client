export interface UIMessages {
	...
	"aptext": string;
	"races.info.apvalue": string;
	"races.info.lifepointbasevalue": string;
	"races.info.spiritbasevalue": string;
	"races.info.toughnessbasevalue": string;
	"races.info.movementbasevalue": string;
	"races.info.attributeadjustments": string;
	"races.info.commoncultures": string;
	"races.info.automaticadvantages": string;
	"races.info.stronglyrecommendedadvantages": string;
	"races.info.stronglyrecommendeddisadvantages": string;
	"races.info.commonadvantages": string;
	"races.info.commondisadvantages": string;
	"races.info.uncommonadvantages": string;
	"races.info.uncommondisadvantages": string;
	"info.none": string;
