  ...
  return function (param) {
    ...
    return Ley_List$OptolithClient.Foldable.all((function (option) {
                  if (option.TAG) {
                    ...
                    return Caml_obj.caml_notequal(option._0, id);
                  }
                }), partial_arg);
  };
}
...
function getAvailableSelectOptionsTransducer(staticData, hero, magicalTraditions, staticEntry, maybeHeroEntry) {
  ...
  switch (staticEntry.TAG | 0) {
    case /* Advantage */0 :
        ...
        var match = Id$OptolithClient.advantageFromInt(staticAdvantage.id);
    ...
    case /* Disadvantage */1 :
        ...
        var match$1 = Id$OptolithClient.disadvantageFromInt(staticDisadvantage.id);
        ...
        if (match$1 !== 12) {
          ...
          var isAdvActive = function (id) {
            return Activatable_Accessors$OptolithClient.isActiveM(Curry._2(Ley_IntMap$OptolithClient.lookup, Id$OptolithClient.advantageToInt(id), hero.advantages));
          };
          return (function (fold) {
                                  ...
                                  if (isAdvActive(/* SociallyAdaptable */15) || isAdvActive(/* InspireConfidence */16)) {
                                    ...
                                    if (typeof match === "number" || match.HASH !== 290194801) {
                                      ...
                                      return !Ley_Option$OptolithClient.Foldable.any((function (skill) {
                                                    return skill.gr === Id$OptolithClient.skillGroupToInt(/* Social */1);
    ...
    case /* SpecialAbility */2 :
        ...
        var match$2 = Id$OptolithClient.specialAbilityFromInt(staticSpecialAbility.id);
        ...
        if (match$2 < 72) {
          ...
          if (switcher > 44 || switcher < 0) {
            if (switcher >= 45) {
              var availableLanguages = Ley_Option$OptolithClient.option(/* [] */0, (function (heroLanguage) {
                    ...
                    }), Curry._2(Ley_IntMap$OptolithClient.lookup, Id$OptolithClient.specialAbilityToInt(/* Language */6), hero.specialAbilities));
              return (function (fold) {
            ...
            switch (switcher + 26 | 0) {
              case /* SkillSpecialization */0 :
                  ...
                  var counter = Ley_Option$OptolithClient.Functor.$less$amp$great(maybeHeroEntry, Activatable_SelectOptions$OptolithClient.getActiveOptions2Map);
                  return (function (fold) {
                            var tmp;
                            ...
                            return Ley_Transducer$OptolithClient.$less$amp$tilde(Ley_Transducer$OptolithClient.$great$great$tilde(Curry._1(isNoRequiredSelection$1, fold), tmp), (function (selectOption) {
                                          ...
                                          return Ley_Option$OptolithClient.liftDef((function (selectOption) {
                                                        ...
                                                        return Ley_Option$OptolithClient.Functor.$less$amp$great(tmp, (function (skill) {
                  ...
                  return (function (param) {
                            return filterSpellSelectOptions((function (spell) {
                                          return Ley_List$OptolithClient.disjoint({
                                                      hd: Id$OptolithClient.magicalTraditionToInt(/* General */0),
                                                      tl: {
                                                        hd: Id$OptolithClient.magicalTraditionToInt(/* GuildMages */1),
                                                        tl: /* [] */0
                                                      }
                                                    }, spell.traditions);
                                        }), param);
            ...
            return (function (param) {
                      return filterSpellSelectOptions((function (spell) {
                                    return Ley_List$OptolithClient.disjoint({
                                                hd: Id$OptolithClient.magicalTraditionToInt(/* General */0),
                                                tl: {
                                                  hd: Id$OptolithClient.magicalTraditionToInt(/* Witches */2),
                                                  tl: /* [] */0
                                                }
                                              }, spell.traditions);
                                  }), param);
          ...
          var allowedTraditions_0 = Id$OptolithClient.magicalTraditionToInt(/* Druids */4);
          var allowedTraditions_1 = {
            hd: Id$OptolithClient.magicalTraditionToInt(/* Elves */3),
            tl: {
              hd: Id$OptolithClient.magicalTraditionToInt(/* Witches */2),
              tl: /* [] */0
            }
          ...
          var maybeTransferredSpellFromTradition = Ley_Option$OptolithClient.Monad.$great$great$eq(Curry._2(Ley_IntMap$OptolithClient.lookup, Id$OptolithClient.specialAbilityToInt(/* TraditionGuildMages */9), hero.specialAbilities), (function (specialAbility) {
                  return Ley_Option$OptolithClient.Monad.$great$great$eq(Ley_Option$OptolithClient.listToOption(specialAbility.active), (function (active) {
                                ...
                                return Ley_Option$OptolithClient.Functor.$less$amp$great(Ley_Option$OptolithClient.Monad.$great$great$eq(match !== undefined && !(typeof match === "number" || match.HASH !== 345443720) ? match.VAL : undefined, (function (param) {
          ...
          return Ley_Option$OptolithClient.Monad.$$return(Ley_Option$OptolithClient.option(Ley_Transducer$OptolithClient.idT, (function (transferredSpellFromTradition) {
                            ...
                            return function (param) {
                              return filterSpellSelectOptions((function (spell) {
                                            if (!Ley_List$OptolithClient.notElem(Id$OptolithClient.magicalTraditionToInt(/* General */0), spell.traditions)) {
                                              return false;
                                            }
