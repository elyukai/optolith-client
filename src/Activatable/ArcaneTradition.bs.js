...
function multilingual(json) {
  return {
          ...
          prerequisites: Json_decode.field("prerequisites", Prerequisite$OptolithClient.Collection.ArcaneTradition.Decode.multilingual, json),
...
function t$1(langs, json) {
  ...
  return Curry._2(Ley_Option$OptolithClient.Infix.$less$amp$great, Curry._2(TranslationMap.Decode.getFromLanguageOrder, langs, x.translations), (function (translation) {
                return {
                        ...
                        prerequisites: Curry._2(Prerequisite$OptolithClient.Collection.ArcaneTradition.Decode.resolveTranslations, langs, x.prerequisites)
                      };
              }));
}
