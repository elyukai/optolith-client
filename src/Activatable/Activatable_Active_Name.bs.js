...
var Intl$OptolithClient = require("../Utilities/Intl.bs.js");
var Chars$OptolithClient = require("../Utilities/Chars.bs.js");
var Ley_Int$OptolithClient = require("../Data/Ley_Int.bs.js");
var Integers$OptolithClient = require("../Utilities/Integers.bs.js");
...
var AdvancedFiltering$OptolithClient = require("../Utilities/AdvancedFiltering.bs.js");
  ...
  if (input !== undefined) {
    if (sid !== undefined) {
      if (sid.TAG) {
        ...
        return Ley_Option$OptolithClient.fromOption("", Activatable_SelectOptions$OptolithClient.getSelectOptionName(staticEntry, sid._0)) + (": " + sid2._0);
      } else {
        return ;
      }
    } else {
    ...
    return Activatable_SelectOptions$OptolithClient.getSelectOptionName(staticEntry, sid._0);
  } else {
    return ;
  }
}
        ...
        switch (match) {
          ...
          case /* HatredFor */21 :
              return Curry._3(Ley_Option$OptolithClient.liftM2, (function (type_, frequency) {
                          ...
                          }), Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, Activatable_SelectOptions$OptolithClient.getOption2(heroEntry), Activatable_SelectOptions$OptolithClient.getCustomInput), Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, Activatable_SelectOptions$OptolithClient.getOption1(heroEntry), Activatable_Convert$OptolithClient.activatableOptionToSelectOptionId), (function (param) {
    ...
    case /* SpecialAbility */2 :
          ...
          if (match$2 !== 85) {
            if (match$2 >= 72) {
              ...
              return Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, Curry._1(Ley_Option$OptolithClient.join, Curry._3(Ley_Option$OptolithClient.liftM2, Activatable_SelectOptions$OptolithClient.getSelectOption, Curry._2(Ley_Option$OptolithClient.Infix.$less$amp$great, Curry._2(Ley_IntMap$OptolithClient.lookup, Id$OptolithClient.SpecialAbility.toInt(/* Language */6), staticData.specialAbilities), (function (specialAbility) {
                                      ...
                                      })), Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, Activatable_SelectOptions$OptolithClient.getOption1(heroEntry), Activatable_Convert$OptolithClient.activatableOptionToSelectOptionId))), (function (language) {
        ...
        switch (match$2 - 16 | 0) {
          case /* TerrainKnowledge */1 :
              ...
              if (match$3 === 1) {
                return Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, Activatable_SelectOptions$OptolithClient.getOption1(heroEntry), Activatable_Convert$OptolithClient.activatableOptionToSelectOptionId), (function (param) {
        ...
        if (exit$2 === 3) {
          return Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, Activatable_SelectOptions$OptolithClient.getOption1(heroEntry), Activatable_Convert$OptolithClient.activatableOptionToSelectOptionId), (function (param) {
                            return Activatable_SelectOptions$OptolithClient.getSelectOption(staticEntry, param);
