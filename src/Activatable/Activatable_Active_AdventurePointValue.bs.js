...
var IC$OptolithClient = require("../Increasable/IC.bs.js");
...
function getDefaultApValue(staticEntry, singleHeroEntry) {
  ...
  var optionApValue = Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, Curry._2(Ley_Option$OptolithClient.Infix.$great$great$eq, sid1, Activatable_Convert$OptolithClient.activatableOptionToSelectOptionId), (function (param) {
...
function getApValueDifferenceOnChangeByEntry(isEntryToAdd, staticData, hero, staticEntry, heroEntry, singleHeroEntry) {
  var sid1 = Activatable_SelectOptions$OptolithClient.getOption1(singleHeroEntry);
  ...
  var match = Activatable_Accessors$OptolithClient.idDeepVariant(staticEntry);
  var exit = 0;
  switch (match.TAG | 0) {
    case /* Advantage */0 :
...
function getApValueDifferenceOnChange(isEntryToAdd, automaticAdvantages, staticData, hero, staticEntry, heroEntry, singleHeroEntry) {
  ...
  if (customCost !== undefined) {
    ...
    return {
            apValue: Curry._1(modifyAbs, Ley_Option$OptolithClient.fromOption(0, getApValueDifferenceOnChangeByEntry(isEntryToAdd, staticData, hero, staticEntry, heroEntry, singleHeroEntry))),
            isAutomatic: isAutomatic
          };
  }
}

exports.getApValueDifferenceOnChange = getApValueDifferenceOnChange;
