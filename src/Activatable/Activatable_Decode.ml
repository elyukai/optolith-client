...
module SelectOptions = struct
  module Decode = struct
  type derivedSelectOptionPrerequisite = { target: Id.Activatable.t; active: bool; level: int option }

  type derivedIncreasablePrerequisite = Self of int | SelectOption of derivedSelectOptionPrerequisite

  type derivedIncreasableApValue = DerivedFromIc of int | Fixed of { list: int Ley_IntMap.t; default: int}
  ...
  type derived =
    ...
    | Aspects of { requireKnowledge: bool option; useMasterOfSuffixAsName :bool option }
    | Diseases of { useHalfLevelAsApValue :bool option }
    | Poisons of { useHalfLevelAsApValue :bool option }
    | Languages of { prerequisites : derivedSelectOptionPrerequisite list option }
    | MeleeCombatTechniques of { groups: int list option; specific: specific option; prerequisites: derivedIncreasablePrerequisite list option; apValue: derivedIncreasableApValue option }
    | RangedCombatTechniques of { groups: int list option; specific: specific option; prerequisites: derivedIncreasablePrerequisite list option; apValue: derivedIncreasableApValue option }
    | LiturgicalChants of { groups: int list option; specific: specific option; prerequisites: derivedIncreasablePrerequisite list option; apValue: derivedIncreasableApValue option }
    | Ceremonies of { groups: int list option; specific: specific option; prerequisites: derivedIncreasablePrerequisite list option; apValue: derivedIncreasableApValue option }
    | Skills of { groups: int list option; specific: specific option; prerequisites: derivedIncreasablePrerequisite list option; apValue: derivedIncreasableApValue option }
    | Spells of { groups: int list option; specific: specific option; prerequisites: derivedIncreasablePrerequisite list option; apValue: derivedIncreasableApValue option }
    | Rituals of { groups: int list option; specific: specific option; prerequisites: derivedIncreasablePrerequisite list option; apValue: derivedIncreasableApValue option }
