...
function getInactive(cache, staticData, hero, staticEntry, maybeHeroEntry) {
  ...
  if (isAdditionValid) {
    return Ley_Option$OptolithClient.option({
                  ...
                  return {
                ...
                }), Ley_Option$OptolithClient.Monad.$great$great$eq(Ley_Option$OptolithClient.Monad.$less$amp$great(Activatable_Inactive_SelectOptions$OptolithClient.getAvailableSelectOptions(staticData, hero, cache.magicalTraditions, staticEntry, maybeHeroEntry), (function (selectOptions) {
                          var tmp;
                          switch (staticEntry.TAG | 0) {
                            case /* Advantage */0 :
                                tmp = Ley_List$OptolithClient.elem(staticEntry._0.id, cache.automaticAdvantages);
                                break;
                            case /* Disadvantage */1 :
                      ...
                      switch (staticEntry.TAG | 0) {
                        ...
                        case /* SpecialAbility */2 :
                              ...
                              switch (match$1) {
                                case /* CraftInstruments */2 :
                                    var getSkillValue = function (skill) {
                                      return Skills$OptolithClient.getValueDef(Curry._2(Ley_IntMap$OptolithClient.lookup, Id$OptolithClient.Skill.toInt(skill), hero.skills));
                                    };
                                ...
                                case /* Hunter */3 :
                                    if (Curry._2(Ley_IntMap$OptolithClient.IntMap.Foldable.any, (function (param) {
                                ...
                                case /* Recherchegespuer */29 :
                                    return Ley_Option$OptolithClient.Monad.$great$great$eq(Ley_Option$OptolithClient.Monad.$great$great$eq(Ley_Option$OptolithClient.Monad.$great$great$eq(Ley_Option$OptolithClient.Monad.$great$great$eq(Ley_Option$OptolithClient.Monad.$less$amp$great(Curry._2(Ley_IntMap$OptolithClient.lookup, Id$OptolithClient.SpecialAbility.toInt(/* Wissensdurst */28), hero.specialAbilities), (function (param) {
                                                                  return param.active;
                                                  ...
                                                  var sumValues = Ley_List$OptolithClient.map((function (param) {
                                                          return partial_arg + param | 0;
                                                        }), match._0);
                                                  return Ley_Option$OptolithClient.Monad.$$return({
                                                              id: base.id,
                                                              name: base.name,
                                                              apValue: {
                                                                TAG: /* Many */1,
                                ...
                                case /* DunklesAbbildDerBuendnisgabe */47 :
                                    return Ley_Option$OptolithClient.Monad.$great$great$eq(hero.pact, (function (param) {
                            ...
                            switch (exit) {
                              case 1 :
                                  if (Ley_List$OptolithClient.Foldable.$$null(cache.magicalTraditions)) {
                                    return base;
                                  } else {
                                    return ;
                                  }
                              case 2 :
                                  ...
                                  var index = Ley_Option$OptolithClient.option(0, (function (param) {
                                          return Ley_List$OptolithClient.Foldable.length(param.active);
                                        }), maybeHeroEntry);
                                  return Ley_Option$OptolithClient.Functor.$less$amp$great(Ley_List$OptolithClient.Safe.atMay(match$2._0, index), (function (apValue) {
                                                return {
                                                        id: base.id,
                                                        name: base.name,
                                                        apValue: {
                              ...
                              case 6 :
                                  if (cache.adventurePoints.spentOnMagicalAdvantages <= 25 && cache.adventurePoints.spentOnMagicalDisadvantages <= 25 && Ley_List$OptolithClient.Foldable.$$null(cache.magicalTraditions)) {
                                    return base;
                                  } else {
                                    return ;
                                  }
