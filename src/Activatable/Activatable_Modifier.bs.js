...
function getLevel(maybeEntry) {
  return Ley_Option$OptolithClient.Foldable.sum(Ley_Option$OptolithClient.Monad.$great$great$eq(Ley_Option$OptolithClient.Monad.$great$great$eq(maybeEntry, (function (entry) {
