...
type characterListVisibilityFilter =
  | All
  | Own
  | Shared;

type raceListSortOrder =
  | Name
  | ApValue;

type cultureListSortOrder =
  | Name
  | ApValue;

type cultureListVisibilityFilter =
  | All
  | Common;

type professionListSortOrder =
  | Name
  | ApValue;

type professionListVisibilityFilter =
  | All
  | Common;

type professionListGroupVisibilityFilter =
  | All
  | Mundane
  | Magical
  | Blessed;

type skillListSortOrder =
  | Name
  | Group
  | IC;

type specialAbilityListSortOrder =
  | Name
  | Group;

type combatTechniqueListSortOrder =
  | Name
  | Group
  | IC;

type spellListSortOrder =
  | Name
  | Group
  | Property
  | IC;

type liturgicalChantListSortOrder =
  | Name
  | Group
  | IC;

type equipmentListSortOrder =
  | Name
  | Group
  | Where
  | Weight;
...
type t = {
  ...
  meleeItemTemplatesCombatTechniqueFilter: option(string),
  rangedItemTemplatesCombatTechniqueFilter: option(string),
  ...
  module Old = {
    ...
    let t = json =>
      JsonStrict.{
        ...
        cultureListVisibilityFilter:
          json
          |> field("culturesVisibilityFilter", cultureListVisibilityFilter),
        professionListSortOrder:
        ...
        advantageDisadvantageListCultureRatingVisibility:
          json
          |> field("advantagesDisadvantagesCultureRatingVisibility", bool),
        skillListSortOrder:
