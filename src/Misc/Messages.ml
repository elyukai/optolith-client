    ...
    Json.Decode.
      {
        ...
        macosmenubar_preferences =
          json |> field "macosmenubar.preferences" string;
        ...
        initialization_loadtableserror =
          json |> field "initialization.loadtableserror" string;
        ...
        header_tabs_thirdpartylicenses =
        ...
        header_tabs_personaldata =
          json |> field "header.tabs.personaldata" string;
        header_tabs_charactersheet =
          json |> field "header.tabs.charactersheet" string;
        header_tabs_pact = json |> field "header.tabs.pact" string;
        header_tabs_rules = json |> field "header.tabs.rules" string;
        header_tabs_racecultureandprofession =
        ...
        header_tabs_advantagesanddisadvantages =
          json |> field "header.tabs.advantagesanddisadvantages" string;
        header_tabs_advantages = json |> field "header.tabs.advantages" string;
        header_tabs_disadvantages =
          json |> field "header.tabs.disadvantages" string;
        header_tabs_abilities = json |> field "header.tabs.abilities" string;
        header_tabs_skills = json |> field "header.tabs.skills" string;
        header_tabs_combattechniques =
          json |> field "header.tabs.combattechniques" string;
        header_tabs_specialabilities =
          json |> field "header.tabs.specialabilities" string;
        header_tabs_spells = json |> field "header.tabs.spells" string;
        header_tabs_liturgicalchants =
          json |> field "header.tabs.liturgicalchants" string;
        ...
        header_tabs_hitzonearmor =
          json |> field "header.tabs.hitzonearmor" string;
        ...
        header_aptooltip_spentonadvantages =
          json |> field "header.aptooltip.spentonadvantages" string;
        header_aptooltip_spentonmagicadvantages =
          json |> field "header.aptooltip.spentonmagicadvantages" string;
        header_aptooltip_spentonblessedadvantages =
          json |> field "header.aptooltip.spentonblessedadvantages" string;
        header_aptooltip_spentondisadvantages =
          json |> field "header.aptooltip.spentondisadvantages" string;
        header_aptooltip_spentonmagicdisadvantages =
          json |> field "header.aptooltip.spentonmagicdisadvantages" string;
        header_aptooltip_spentonblesseddisadvantages =
          json |> field "header.aptooltip.spentonblesseddisadvantages" string;
        header_aptooltip_spentonrace =
          json |> field "header.aptooltip.spentonrace" string;
        header_aptooltip_spentonprofession =
          json |> field "header.aptooltip.spentonprofession" string;
        header_aptooltip_spentonattributes =
          json |> field "header.aptooltip.spentonattributes" string;
        header_aptooltip_spentonskills =
          json |> field "header.aptooltip.spentonskills" string;
        header_aptooltip_spentoncombattechniques =
          json |> field "header.aptooltip.spentoncombattechniques" string;
        header_aptooltip_spentonspells =
          json |> field "header.aptooltip.spentonspells" string;
        header_aptooltip_spentoncantrips =
          json |> field "header.aptooltip.spentoncantrips" string;
        header_aptooltip_spentonliturgicalchants =
          json |> field "header.aptooltip.spentonliturgicalchants" string;
        header_aptooltip_spentonblessings =
          json |> field "header.aptooltip.spentonblessings" string;
        header_aptooltip_spentonspecialabilities =
          json |> field "header.aptooltip.spentonspecialabilities" string;
        header_aptooltip_spentonenergies =
          json |> field "header.aptooltip.spentonenergies" string;
        header_dialogs_herosaved =
          json |> field "header.dialogs.herosaved" string;
        header_dialogs_allsaved = json |> field "header.dialogs.allsaved" string;
        header_dialogs_everythingelsesaved =
          json |> field "header.dialogs.everythingelsesaved" string;
        header_dialogs_saveconfigerror_title =
          json |> field "header.dialogs.saveconfigerror.title" string;
        header_dialogs_saveconfigerror_message =
          json |> field "header.dialogs.saveconfigerror.message" string;
        header_dialogs_saveheroeserror_title =
          json |> field "header.dialogs.saveheroeserror.title" string;
        header_dialogs_saveheroeserror_message =
          json |> field "header.dialogs.saveheroeserror.message" string;
        ...
        heroes_dialogs_herocreation_experiencelevel_placeholder =
          json
          |> field "heroes.dialogs.herocreation.experiencelevel.placeholder"
               string;
        ...
        sheets_mainsheet_derivedcharacteristics_labels_bonuspenalty =
          json
          |> field "sheets.mainsheet.derivedcharacteristics.labels.bonuspenalty"
               string;
        ...
        sheets_mainsheet_derivedcharacteristics_labels_bought =
          json
          |> field "sheets.mainsheet.derivedcharacteristics.labels.bought"
               string;
        ...
        sheets_mainsheet_derivedcharacteristics_labels_current =
          json
          |> field "sheets.mainsheet.derivedcharacteristics.labels.current"
               string;
        sheets_mainsheet_derivedcharacteristics_labels_basestat =
          json
          |> field "sheets.mainsheet.derivedcharacteristics.labels.basestat"
               string;
        sheets_mainsheet_derivedcharacteristics_labels_permanentlylostboughtback =
          json
          |> field
        ...
        sheets_gamestatssheet_skillstable_labels_improvementcost =
          json
          |> field "sheets.gamestatssheet.skillstable.labels.improvementcost"
               string;
        ...
        sheets_gamestatssheet_skillstable_labels_routinechecks =
          json
          |> field "sheets.gamestatssheet.skillstable.labels.routinechecks"
               string;
        ...
        sheets_gamestatssheet_qualitylevels_labels_skillpoints =
          json
          |> field "sheets.gamestatssheet.qualitylevels.labels.skillpoints"
               string;
        sheets_gamestatssheet_qualitylevels_labels_qualitylevel =
          json
          |> field "sheets.gamestatssheet.qualitylevels.labels.qualitylevel"
               string;
        ...
        sheets_combatsheet_combattechniquestable_labels_parry =
          json
          |> field "sheets.combatsheet.combattechniquestable.labels.parry"
               string;
        ...
        sheets_combatsheet_closecombatweapons_labels_damagebonus =
          json
          |> field "sheets.combatsheet.closecombatweapons.labels.damagebonus"
               string;
        sheets_combatsheet_closecombatweapons_labels_damagepoints =
          json
          |> field "sheets.combatsheet.closecombatweapons.labels.damagepoints"
               string;
        ...
        sheets_combatsheet_rangedcombatweapons_labels_reloadtime =
          json
          |> field "sheets.combatsheet.rangedcombatweapons.labels.reloadtime"
               string;
        sheets_combatsheet_rangedcombatweapons_labels_damagepoints =
          json
          |> field "sheets.combatsheet.rangedcombatweapons.labels.damagepoints"
               string;
        sheets_combatsheet_rangedcombatweapons_labels_ammunition =
          json
          |> field "sheets.combatsheet.rangedcombatweapons.labels.ammunition"
               string;
        sheets_combatsheet_rangedcombatweapons_labels_rangebrackets =
          json
          |> field "sheets.combatsheet.rangedcombatweapons.labels.rangebrackets"
               string;
        ...
        sheets_combatsheet_rangedcombatweapons_labels_damaged =
          json
          |> field "sheets.combatsheet.rangedcombatweapons.labels.damaged"
               string;
        sheets_combatsheet_rangedcombatweapons_labels_rangedcombat =
          json
          |> field "sheets.combatsheet.rangedcombatweapons.labels.rangedcombat"
               string;
        ...
        sheets_combatsheet_armors_labels_carriedwhereexamples =
          json
          |> field "sheets.combatsheet.armors.labels.carriedwhereexamples"
               string;
        ...
        sheets_combatsheet_shieldparryingweapon_labels_damaged =
          json
          |> field "sheets.combatsheet.shieldparryingweapon.labels.damaged"
               string;
        ...
        sheets_combatsheet_shieldparryingweapon_labels_weight =
          json
          |> field "sheets.combatsheet.shieldparryingweapon.labels.weight"
               string;
        ...
        sheets_belongingssheet_equipmenttable_labels_carriedwhere =
          json
          |> field "sheets.belongingssheet.equipmenttable.labels.carriedwhere"
               string;
        ...
        sheets_spellssheet_spellstable_labels_improvementcost =
          json
          |> field "sheets.spellssheet.spellstable.labels.improvementcost"
               string;
        ...
        sheets_chantssheet_chantstable_labels_improvementcost =
          json
          |> field "sheets.chantssheet.chantstable.labels.improvementcost"
               string;
        ...
        attributes_derivedcharacteristics_tooltips_boughtback =
          json
          |> field "attributes.derivedcharacteristics.tooltips.boughtback"
               string;
        ...
        attributes_removeenergypointslostpermanently_removebtn =
          json
          |> field "attributes.removeenergypointslostpermanently.removebtn"
               string;
        ...
        advantagesdisadvantages_header_adventurepoints_tooltip =
          json
          |> field "advantagesdisadvantages.header.adventurepoints.tooltip"
               string;
        ...
        advantagesdisadvantages_apspent_spentonmagicadvantages =
          json
          |> field "advantagesdisadvantages.apspent.spentonmagicadvantages"
               string;
        advantagesdisadvantages_apspent_spentonblessedadvantages =
          json
          |> field "advantagesdisadvantages.apspent.spentonblessedadvantages"
               string;
        ...
        advantagesdisadvantages_apspent_spentonmagicdisadvantages =
          json
          |> field "advantagesdisadvantages.apspent.spentonmagicdisadvantages"
               string;
        advantagesdisadvantages_apspent_spentonblesseddisadvantages =
          json
          |> field "advantagesdisadvantages.apspent.spentonblesseddisadvantages"
               string;
        ...
        inlinewiki_combattechniques_groups_allmeleecombattechniques =
          json
          |> field "inlinewiki.combattechniques.groups.allmeleecombattechniques"
               string;
        ...
        combattechniques_header_combattechniquerating_tooltip =
          json
          |> field "combattechniques.header.combattechniquerating.tooltip"
               string;
        ...
        inlinewiki_youcannotuseamodificationonthisspellscastingtime =
          json
          |> field "inlinewiki.youcannotuseamodificationonthisspellscastingtime"
               string;
        inlinewiki_youcannotuseamodificationonthisspellsritualtime =
          json
          |> field "inlinewiki.youcannotuseamodificationonthisspellsritualtime"
               string;
        ...
        inlinewiki_youcannotuseamodificationonthisspellsrange =
          json
          |> field "inlinewiki.youcannotuseamodificationonthisspellsrange"
               string;
        inlinewiki_youcannotuseamodificationonthisspellsduration =
          json
          |> field "inlinewiki.youcannotuseamodificationonthisspellsduration"
               string;
        ...
        inlinewiki_youcannotuseamodificationonthischantsrange =
          json
          |> field "inlinewiki.youcannotuseamodificationonthischantsrange"
               string;
        inlinewiki_youcannotuseamodificationonthischantsduration =
          json
          |> field "inlinewiki.youcannotuseamodificationonthischantsduration"
               string;
        ...
        equipment_purse_initialstartingwealthandcarryingcapacity =
          json
          |> field "equipment.purse.initialstartingwealthandcarryingcapacity"
               string;
        ...
        equipment_dialogs_addedit_breakingpointratingmodifier =
          json
          |> field "equipment.dialogs.addedit.breakingpointratingmodifier"
               string;
        ...
        inlinewiki_equipment_primaryattributeanddamagethreshold =
          json
          |> field "inlinewiki.equipment.primaryattributeanddamagethreshold"
               string;
