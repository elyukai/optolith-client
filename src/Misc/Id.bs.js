  ...
  if (cat >= 255955901) {
    if (cat >= 631587064) {
      if (cat >= 797131559) {
        ...
        } else if (cat >= 815329587) {
          return 24;
        } else {
          return 22;
        }
      } else if (cat >= 714749776) {
        if (cat >= 732819676) {
          return 30;
        } else {
          return 19;
        }
      } else if (cat >= 640409038) {
        return 3;
      } else {
        return 25;
      }
    } else if (cat >= 419476828) {
      if (cat >= 503761275) {
        if (cat >= 531138952) {
          return 14;
        } else {
      ...
      } else if (cat >= 482562044) {
        return 5;
      } else {
        return 28;
      }
    } else if (cat >= 345443720) {
      if (cat >= 389604849) {
        return 32;
      } else {
        return 10;
      }
    } else if (cat >= 290194801) {
      return 8;
    } else {
      return 7;
    }
  } else if (cat >= -511329806) {
    if (cat >= -211539695) {
      if (cat >= -41058677) {
        if (cat >= 163880078) {
          return 16;
      ...
      } else if (cat >= -197856037) {
        return 15;
      } else {
        return 13;
      }
    } else if (cat >= -384382742) {
      if (cat >= -376758272) {
        return 26;
      } else {
        return 21;
      }
    } else if (cat >= -390491302) {
      return 1;
    } else {
      return 11;
    }
  } else if (cat >= -841776939) {
    if (cat >= -590980171) {
      if (cat >= -578883726) {
        return 17;
      } else {
    ...
    } else if (cat >= -789492591) {
      return 23;
    } else {
      return 20;
    }
  } else if (cat >= -920806756) {
    if (cat >= -895040740) {
      return 4;
    } else {
      return 9;
    }
  } else if (cat >= -988696364) {
    return 29;
  } else {
    return 12;
  }
...
function compare(param, param$1) {
  var x$prime = toInt(param[0]);
  var y$prime = toInt(param$1[0]);
  if (x$prime === y$prime) {
...
function $eq$1(x, y) {
  ...
  if (match !== -41058677) {
    ...
    } else if (y[0] !== -789492591) {
      return false;
    } else {
      return x[1] === y[1];
    }
  } else if (y[0] !== -41058677) {
    return false;
  } else {
    return x[1] === y[1];
  }
...
function compare$1(param, param$1) {
  var x$prime = toInt$1(param[0]);
  var y$prime = toInt$1(param$1[0]);
  if (x$prime === y$prime) {
    return param[1] - param$1[1] | 0;
  } else {
    return x$prime - y$prime | 0;
...
function $eq$3(x, y) {
  ...
  var match$1 = match[0];
  if (match$1 >= 61643255) {
    if (match$1 >= 345443720) {
      if (match$1 >= 797131559) {
        if (y.TAG) {
          return false;
        }
        var match$2 = y._0;
        if (match$2[0] !== 797131559) {
          return false;
        } else {
      ...
      var match$3 = y._0;
      if (match$3[0] !== 345443720) {
        return false;
      } else {
        return match[1] === match$3[1];
      }
    }
    if (match$1 >= 290194801) {
      if (y.TAG) {
        return false;
      }
      var match$4 = y._0;
      if (match$4[0] !== 290194801) {
        return false;
      } else {
    ...
    var match$5 = y._0;
    if (match$5[0] !== 61643255) {
      return false;
    } else {
      return match[1] === match$5[1];
    }
  }
  if (match$1 >= -789492591) {
    if (match$1 >= -384382742) {
      if (y.TAG) {
        return false;
      }
      var match$6 = y._0;
      if (match$6[0] !== -384382742) {
        return false;
      } else {
    ...
    var match$7 = y._0;
    if (match$7[0] !== -789492591) {
      return false;
    } else {
      return match[1] === match$7[1];
    }
  }
  if (match$1 >= -841776939) {
    if (y.TAG) {
      return false;
    }
    var match$8 = y._0;
    if (match$8[0] !== -841776939) {
      return false;
    } else {
  ...
  var match$9 = y._0;
  if (match$9[0] !== -920806756) {
    return false;
  } else {
    return match[1] === match$9[1];
  }
}
