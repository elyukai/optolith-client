...
function unsafeFromInt(id) {
  ...
  if (switcher > 2 || switcher < 0) {
    return Pervasives.invalid_arg("fromInt: " + (Int$OptolithClient.show(id) + " is not a valid phase"));
  } else {
    return switcher;
  }
}
...
function unsafeFromInt$1(id) {
  ...
  if (switcher > 6 || switcher < 0) {
    return Pervasives.invalid_arg("fromInt: " + (Int$OptolithClient.show(id) + " is not a valid experience level"));
  } else {
    return switcher;
  }
}
