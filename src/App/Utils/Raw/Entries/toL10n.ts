  ...
  (l10n_table: List<OrderedMap<string, string>>) => {
      ...
      return mapMNamed
        ({
          ...
          "stability.short": checkL10nNonEmptyString ("stability.short"),
          ...
          "properties.oneormore": checkL10nNonEmptyString ("properties.oneormore"),
          ...
          "dicelist": checkL10nNonEmptyStringList ("dicelist"),
