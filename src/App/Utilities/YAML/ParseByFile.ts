...
export const parseByFile =
  ...
  (l10nParser : YamlParser) =>
  async (defaultParser : YamlParser) : MapEitherIO<Error[], YamlNameMap> =>
    mapMObjectIO ({
      AdvantagesL10n:
      ...
      CombatSpecialAbilityGroupsDefault:
        // eslint-disable-next-line max-len
      ...
      LiturgicalChantEnhancementsDefault:
        // eslint-disable-next-line max-len
