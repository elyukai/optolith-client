...
function l10n$31(json) {
  return {
          ...
          level1: Json_decode.field("level1", level, json),
          level2: Json_decode.field("level2", level, json),
          level3: Json_decode.field("level3", level, json),
          src: Json_decode.field("src", fromJson, json),
          errata: Json_decode.field("errata", fromJson$1, json)
        };
}
...
function level2(json) {
  return {
          id: Json_decode.field("id", Json_decode.$$int, json),
          cost: Json_decode.field("cost", Json_decode.$$int, json),
          previousRequirement: Maybe$OptolithClient.isJust(Json_decode.field("previousRequirement", (function (param) {
                      return maybe((function (param) {
                                    return $$const(1, param);
                                  }), param);
                    }), json))
        };
}
...
function level3(json) {
  ...
  return {
          id: Json_decode.field("id", Json_decode.$$int, json),
          cost: Json_decode.field("cost", Json_decode.$$int, json),
          previousRequirement: Json_decode.field("previousRequirement", (function (param) {
                  return maybe(partial_arg$1, param);
                }), json)
        };
}
...
function univ$16(json) {
  return {
          target: Json_decode.field("target", Json_decode.$$int, json),
          level1: Json_decode.field("level1", level1, json),
          level2: Json_decode.field("level2", level2, json),
          level3: Json_decode.field("level3", level3, json)
        };
}
...
function l10n$52(json) {
  return {
          target: Json_decode.field("target", Json_decode.$$int, json),
          level1: Json_decode.field("level1", level$1, json),
          level2: Json_decode.field("level2", level$1, json),
          level3: Json_decode.field("level3", level$1, json),
          src: Json_decode.field("src", fromJson, json),
          errata: Json_decode.field("errata", fromJson$1, json)
        };
}
...
function univ$28(json) {
  return {
          target: Json_decode.field("target", Json_decode.$$int, json),
          level1: Json_decode.field("level1", level1$1, json),
          level2: Json_decode.field("level2", level2$1, json),
          level3: Json_decode.field("level3", level3$1, json)
        };
}
...
function fromJson$110(yaml) {
  return Json_decode.list(l10n$59, yaml.zibiljaRitualsL10n);
}
