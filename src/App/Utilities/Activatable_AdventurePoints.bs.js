...
function getDefaultEntryCost(staticEntry, singleHeroEntry) {
  ...
  var apValue = Ley_Option$OptolithClient.fromOption(/* Flat */Block.__(0, [0]), Activatable_Accessors$OptolithClient.apValue(staticEntry));
  ...
  if (!apValue.tag) {
    return Caml_int32.imul(apValue[0], level);
  }
  var xs = apValue[0];
        ...
        switch (match$1 - 12 | 0) {
          case /* AfraidOf */0 :
              ...
              if (isPersonalityFlawNotPaid(7, 1) || isPersonalityFlawNotPaid(8, 2)) {
                ...
                return Activatable_SelectOptions$OptolithClient.getSelectOptionCost(staticEntry, /* `Generic */[
                            61643255,
                            selected_option
                          ]);
              }
