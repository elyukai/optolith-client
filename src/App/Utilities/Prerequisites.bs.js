...
function flattenPrerequisitesRange(oldLevel, newLevel, prerequisites) {
  if (Curry._1(Ley_IntMap$OptolithClient.$$null, prerequisites.levels)) {
    ...
    return Curry._3(Ley_IntMap$OptolithClient.Foldable.foldr, flattenPrerequisites, getFirstLevelPrerequisites(prerequisites), filterApplicableLevels(oldLevel, newLevel, prerequisites.levels));
  }
}
