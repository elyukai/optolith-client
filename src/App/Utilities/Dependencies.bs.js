...
function filterUnfamiliar(pred, staticData, selectOptions) {
  return Ley_List$OptolithClient.filter((function (x) {
                var match = x.id;
                return Ley_Option$OptolithClient.option(false, pred, typeof match === "number" || match.HASH !== 345443720 ? undefined : Curry._2(Ley_IntMap$OptolithClient.lookup, match.VAL, staticData.spells));
              }), selectOptions);
}
