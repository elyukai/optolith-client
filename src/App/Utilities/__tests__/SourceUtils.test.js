...
describe ("groupInt", () => {
  it ("should return the same list if there are no ints to group", () => {
    expect (SourceUtils.groupInt (List (1, 3, 5, 7, 9)))
      .toEqual (List (1, 3, 5, 7, 9))
  })

  it ("should return a grouped list if there are ints to group", () => {
    expect (SourceUtils.groupInt (List (1, 3, 4, 5, 7, 9, 10, 12)))
      // @ts-ignore
