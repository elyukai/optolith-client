...
describe("comparePage", () => {
  it("returns 0 if the pages are equal", () => {
    ...
    assert.equal(
      comparePage({ tag: "Numbered", numbered: 42 }, { tag: "Numbered", numbered: 42 }),
      0,
    )
  })
  ...
  it("returns a negative number if first should be sorted before the second", () => {
    ...
    assert.equal(
      comparePage({ tag: "Numbered", numbered: 24 }, { tag: "Numbered", numbered: 42 }),
      -18,
    )
  })
  ...
  it("returns a positive number if first should be sorted after the second", () => {
    ...
    assert.equal(
      comparePage({ tag: "Numbered", numbered: 42 }, { tag: "Numbered", numbered: 24 }),
      18,
    )
  })
})
