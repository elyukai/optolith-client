...
function decodeVariantOverride(decoder, json) {
  return JsonStrict$OptolithClient.oneOf({
              hd: (function (json) {
...
function decodeVariantSkillSpecializationOption(param) {
  return decodeVariantOverride(Prerequisite$OptolithClient.oneOrManyInt, param);
}
...
function decodeVariantCombatTechniqueOption(param) {
  return decodeVariantOverride(decodeCombatTechniqueOption, param);
}
...
function decode(json) {
  return {
          skillSpecialization: JsonStrict$OptolithClient.optionalField("skillSpecialization", Prerequisite$OptolithClient.oneOrManyInt, json),
...
var Options = {
  ...
  decodeSkillSpecializationOption: Prerequisite$OptolithClient.oneOrManyInt,
...
function decode$1(json) {
  return {
          name: JsonStrict$OptolithClient.field("name", decodeName, json),
  ...
  return {
          ...
          spells: Ley_Option$OptolithClient.option(Ley_IntMap$OptolithClient.empty, Ley_IntMap$OptolithClient.fromList, JsonStrict$OptolithClient.optionalField("spells", (function (param) {
                      return JsonStrict$OptolithClient.list((function (json) {
                                    return [
                                            JsonStrict$OptolithClient.field("id", JsonStrict$OptolithClient.$$int, json),
                                            JsonStrict$OptolithClient.field("value", Prerequisite$OptolithClient.oneOrManyInt, json)
                                          ];
                                  }), param);
                    }), json)),
...
var Variant = {
  ...
  decodeMultilingualPair: decodeMultilingualPair,
...
function decode$2(json) {
  return {
          name: JsonStrict$OptolithClient.field("name", decodeName, json),
          subname: JsonStrict$OptolithClient.optionalField("subname", decodeName, json),
...
function decodeMultilingual$1(json) {
  return {
          ...
          isVariantRequired: JsonStrict$OptolithClient.field("isVariantRequired", JsonStrict$OptolithClient.bool, json),
...
var Static = {
  ...
  decodeMultilingual: decodeMultilingual$1,
